package com.raiadnan.ads.sdk.adapter;

import static com.raiadnan.ads.sdk.util.Constant.ADMOB;
import static com.raiadnan.ads.sdk.util.Constant.APPLOVIN;
import static com.raiadnan.ads.sdk.util.Constant.APPLOVIN_DISCOVERY;
import static com.raiadnan.ads.sdk.util.Constant.APPLOVIN_MAX;
import static com.raiadnan.ads.sdk.util.Constant.FACEBOOK;
import static com.raiadnan.ads.sdk.util.Constant.FAN;
import static com.raiadnan.ads.sdk.util.Constant.GOOGLE_AD_MANAGER;
import static com.raiadnan.ads.sdk.util.Constant.STARTAPP;
import static com.raiadnan.ads.sdk.util.Constant.WORTISE;
...
import com.raiadnan.ads.sdk.format.NativeAdViewHolder;
import com.raiadnan.ads.sdk.R;
import com.raiadnan.ads.sdk.data.Constant;
import com.raiadnan.ads.sdk.database.SharedPref;
import com.raiadnan.ads.sdk.model.Post;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            switch (Constant.NATIVE_STYLE) {
                case "news":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.raiadnan.ads.sdk.R.layout.view_native_ad_news, parent, false);
                    break;
                case "radio":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.raiadnan.ads.sdk.R.layout.view_native_ad_radio, parent, false);
                    break;
                case "video_small":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.raiadnan.ads.sdk.R.layout.view_native_ad_video_small, parent, false);
                    break;
                case "video_large":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.raiadnan.ads.sdk.R.layout.view_native_ad_video_large, parent, false);
                    break;
                default:
                    v = LayoutInflater.from(parent.getContext()).inflate(com.raiadnan.ads.sdk.R.layout.view_native_ad_medium, parent, false);
                    break;
            }
